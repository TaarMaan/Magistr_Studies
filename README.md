...
### 3.2 Технологии промышленного программирования
  ...
  В данной дисциплине были рассмотрены способы запуска и организации взаимодействия параллельных процессов, нитей, работы с именованной памятью и службой реального времен. работа представлена в виде отчетов по 3-м лабораторным работам, с приложенным кодом основных модулей в среде разработки QNX и части отвечающей за виртуализацию всех процессов, по средствам предоставления "сервера", в виде виртуальной машины Vmare.

### 3.3 Моделирование систем реального времени, распределенных и параллельных приложений на языке UML

В ходе данного курса юыли изучены способы создания микросервисной архитектуры Java приложений. Выполняя лабораторные работы, были получены навыки: 
...
### 3.4 Методы планирования Эксперимента и статической обработки информации
  ...
  В ходе курса по планированию эксперимента, были изучены методы статической обработки данных, в виде различных анализов, оценок и проведения необходимых экспирементов. Проведены 5 лабораторных работ, при помощи программы для работы с электронными таблицами Microsoft Excel и встроенного в нее расширения по работе со статическими данными.
